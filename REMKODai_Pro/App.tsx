...
import { AppTab, Source, Course, UserData, UserPersona, MemoryLog, UserRank } from './types';
...
const App: React.FC = () => {
  ...
  // Çeviri / Localization Yardımcısı
  const t = useCallback((key: string) => {
    ...
    const strings: any = {
      ...
      'need_package': isEn ? 'You must acquire at least one Skill Package to use Atelier tools.' : 'Atölye araçlarını kullanabilmek için en az bir Beceri Paketi edinmelisiniz.'
    };
